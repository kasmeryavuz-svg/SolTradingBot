...
function loadPositionConfig(source: EnvSource): AppConfig['position'] {
  return {
    historyLimit: parseBoundedPositiveInteger(
...
function loadExitConfig(source: EnvSource): AppConfig['exit'] {
  return {
    historyLimit: parseBoundedPositiveInteger(
...
function loadPerformanceConfig(source: EnvSource): AppConfig['performance'] {
  return {
